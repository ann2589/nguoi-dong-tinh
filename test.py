...
obstacle5 = obstacle("1.png", WIDTH, HEIGHT - 300, 250, 300)
obstacle6 = obstacle("2.png", WIDTH, HEIGHT - 300, 250, 300)
obstacle7 = obstacle("3.png", WIDTH, HEIGHT - 300, 250, 300)
obstacle8 = obstacle("4.png", WIDTH, HEIGHT - 300, 250, 300)
obstacle9 = obstacle("5.png", WIDTH, HEIGHT - 300, 250, 300)
obstacle_list = [obstacle1, obstacle2, obstacle3, obstacle4, obstacle5, obstacle6, obstacle7, obstacle8, obstacle9]
...
while running:
    ...
    for obstacle in current_obstacle_list: 
        ...
        if(obstacle.checking_if_killed(flappy_bird.hit_box)):
            running = False
